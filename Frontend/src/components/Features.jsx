    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Services"
                    heading="Smarter interviews for better hiring decisions"
                    description="Leverage AI to assess coding skills, problem solving ability, and communication in real time with accurate, data driven insights."
                />
